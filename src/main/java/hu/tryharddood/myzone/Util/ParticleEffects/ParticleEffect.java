package hu.tryharddood.myzone.Util.ParticleEffects;
...
public enum ParticleEffect {
	...
	BLOCK_CRACK(
			...
			"blockcrack", 37, -1, ParticleProperty.REQUIRES_DATA),
	BLOCK_DUST(
	...
	public static final class ParticlePacket {
		...
		public static void initialize() throws ParticleEffect.ParticlePacket.VersionIncompatibleException {
			...
			try
			{
				version = ReflectionUtils.PackageType.getVersion();
				if (version > 17)
				{
					enumParticle = ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass("EnumParticle");
				}
				Class<?> packetClass = ReflectionUtils.PackageType.MINECRAFT_SERVER.getClass(version < 17 ? "Packet63WorldParticles" : "PacketPlayOutWorldParticles");
			...
			try
			{
				...
				else
				{
					...
					if (this.data != null)
					{
						...
						ReflectionUtils.setValue(this.packet, true, "k", this.effect == ParticleEffect.ITEM_CRACK ? packetData : packetData[0] | packetData[1] << 12);
					}
				}
